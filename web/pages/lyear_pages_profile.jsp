            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="edit-avatar">
                  <img src="<%=request.getContextPath()%>/static/bootstrap/images/users/avatar.jpg" alt="..." class="img-avatar">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/static/bootstrap/js/perfect-scrollbar.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/static/bootstrap/js/main.min.js"></script>
