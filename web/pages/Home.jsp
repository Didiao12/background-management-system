...
<head>
  ...
  <link rel="icon" href="${ctx}/static/bootstrap/imgs/favicon.ico" type="image/ico">
  <meta name="keywords" content="LightYear,光年,后台模板,后台管理系统,光年HTML模板">
  <meta name="description" content="LightYear是一个基于Bootstrap v3.3.7的后台管理系统的HTML模板。">
  <meta name="author" content="yinqi">
  <link rel="stylesheet" href="https://www.jq22.com/jquery/bootstrap-3.3.4.css">
  <link href="${ctx}/static/bootstrap/css/materialdesignicons.min.css.map" rel="stylesheet">
  ...
  <div class="lyear-layout-container">
    ...
    <aside class="lyear-layout-sidebar">
      ...
      <div id="logo" class="sidebar-header">
        <a href="${ctx}/pages/Home.jsp"><img src="${ctx}/static/bootstrap/images/logo-sidebar.png" title="LightYear" alt="LightYear" /></a>
      </div>
      <div class="lyear-layout-sidebar-scroll">

        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            <li class="nav-item active"> <a href="${ctx}/pages/Home.jsp"><i class="mdi mdi-home"></i> 后台首页</a> </li>
      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title" style="color: red">欢迎您尊敬的： ${sessionScope.get("user").roleName}</span>
          </div>

          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                <img class="img-avatar img-avatar-48 m-r-10" src="../static/bootstrap/images/users/avatar.jpg" alt="后台系统" />
                <span>${sessionScope.get("user").nickName} <span class="caret"></span></span>
              </a>
              <ul class="dropdown-menu dropdown-menu-right">
                ...
                <li class="divider"></li>
                <li> <a href="${ctx}/index.jsp" ><i class="mdi mdi-logout-variant"></i> 退出登录</a> </li>
              </ul>
            </li>
            <!--切换主题配色-->
...
<script type="text/javascript" src="../static/bootstrap/js/perfect-scrollbar.min.js"></script>
<script type="text/javascript" src="../static/bootstrap/js/main.min.js"></script>
